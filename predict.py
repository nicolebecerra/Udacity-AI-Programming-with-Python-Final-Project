...
def parse():
    ...
    parser.add_argument('--image_input', help='image file to classifiy (required)',default='flowers/valid/1/image_06749.jpg')
    parser.add_argument('--model_checkpoint', help='model used for classification (required)',default='check.pth')
    parser.add_argument('--top_k', help='how many prediction categories to show [default 5].',default=3)
    parser.add_argument('--category_names', help='file for category names',default='cat_to_name.json')
    parser.add_argument('--gpu', action='store_true', help='gpu option', default='gpu')
