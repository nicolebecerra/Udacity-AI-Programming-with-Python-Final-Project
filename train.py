...
def parse():
    ...
    parser.add_argument('--save_dir', help='directory to save a neural network.', default='check.pth')
    parser.add_argument('--arch', help='models to use OPTIONS[vgg13]', default='vgg')
    parser.add_argument('--learning_rate', help='learning rate', default='0.001')
    parser.add_argument('--hidden_units', help='number of hidden units', default='4096')
